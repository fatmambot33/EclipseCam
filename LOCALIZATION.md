...
- Instrumentation verifies representative French navigation, safety, permission, countdown, and capture-notification resources.
...
This milestone does not claim full application localisation. Remaining production surfaces, especially Gallery/media/export messages and lower-level runtime error strings, must move to resources and receive French translations. Representative locale-switch UI/screenshot coverage is also still required to verify long French labels at large font/display scales.

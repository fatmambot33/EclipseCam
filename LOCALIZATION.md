...
This milestone does not claim full application localisation. Lower-level runtime failure reasons can still originate as English diagnostic strings and need a typed, resource-backed presentation layer. Representative locale-switch screenshot coverage is also still required to verify long French labels at large font/display scales and to audit the remaining production surfaces for hard-coded copy.

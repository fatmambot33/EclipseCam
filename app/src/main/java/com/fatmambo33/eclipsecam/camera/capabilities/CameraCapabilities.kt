...
class CameraCapabilityInventory(context: Context) {
    ...
    private fun mapCapabilities(cameraId: String, characteristics: CameraCharacteristics): CameraCapabilities {
        ...
        val maximumDigitalZoom = characteristics.get(CameraCharacteristics.SCALER_AVAILABLE_MAX_DIGITAL_ZOOM) ?: 1f
        return CameraCapabilities(
            ...
            jpegSizes = streamMap?.getOutputSizes(ImageFormat.JPEG)?.sortedByDescending { it.width.toLong() * it.height }.orEmpty(),
